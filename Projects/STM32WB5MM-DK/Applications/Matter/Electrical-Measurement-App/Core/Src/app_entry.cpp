...
const osThreadAttr_t ShciUserEvtProcess_attr = { .name = CFG_SHCI_USER_EVT_PROCESS_NAME,
        .attr_bits = CFG_SHCI_USER_EVT_PROCESS_ATTR_BITS, .cb_mem =
        CFG_SHCI_USER_EVT_PROCESS_CB_MEM, .cb_size = CFG_SHCI_USER_EVT_PROCESS_CB_SIZE, .stack_mem =
...
const osThreadAttr_t PushButtonProcess_attr = { .name = CFG_PUSH_BUTTON_EVT_PROCESS_NAME,
        ...
        .stack_mem =
        CFG_PUSH_BUTTON_EVT_PROCESS_STACK_MEM, .stack_size = CFG_PUSH_BUTTON_EVT_PROCESS_STACK_SIZE,
        .priority =
...
static void displayConcurrentMode() {
    APP_DBG("Matter Over Thread Electrical-Measurement-App starting...");
}
