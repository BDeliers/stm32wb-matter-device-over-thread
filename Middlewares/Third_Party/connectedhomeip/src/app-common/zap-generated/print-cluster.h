...
#if defined(ZCL_USING_ENEDIS_TIC_CLUSTER_SERVER) || defined(ZCL_USING_ENEDIS_TIC_CLUSTER_CLIENT)
#define CHIP_PRINTCLUSTER_ENEDIS_TIC_CLUSTER { chip::app::Clusters::EnedisTic::Id, "Enedis TIC" },
#else
#define CHIP_PRINTCLUSTER_ENEDIS_TIC_CLUSTER
#endif
...
#define CLUSTER_IDS_TO_NAMES                                                                                                       \
    ...
    CHIP_PRINTCLUSTER_ENEDIS_TIC_CLUSTER                                                                                           \
