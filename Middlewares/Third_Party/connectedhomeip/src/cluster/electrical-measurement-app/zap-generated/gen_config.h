...
#define EMBER_AF_ENEDIS_TIC_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
// Use this macro to check if the server side of the Enedis TIC cluster is included
#define ZCL_USING_ENEDIS_TIC_CLUSTER_SERVER
#define EMBER_AF_PLUGIN_ENEDIS_TIC_SERVER
#define EMBER_AF_PLUGIN_ENEDIS_TIC
